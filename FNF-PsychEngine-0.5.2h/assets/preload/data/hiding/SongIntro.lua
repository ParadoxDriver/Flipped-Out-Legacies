...
IntroTagColor = '8E08C7'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	setTextSize('JukeBoxText', IntroTextSize)
        setTextFont('JukeBoxText', "neon2.ttf")
	...
	setObjectCamera('JukeBoxSubText', 'other')
        setTextColor('JukeBoxSubText', '8E08C7')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
        setTextFont('JukeBoxSubText', "neon2.ttf")
