...
IntroSubTextSize = 27 --size of the text for the Song Name.
IntroTagColor = 'EB5606'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	setTextSize('JukeBoxText', IntroTextSize)
        setTextFont('JukeBoxText', "Slasher.ttf")
	...
	setObjectCamera('JukeBoxSubText', 'other')
        setTextColor('JukeBoxSubText', 'EB5606')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
        setTextFont('JukeBoxSubText', "Slasher.ttf")
