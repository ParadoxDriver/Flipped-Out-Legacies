...
local ratingGrab = {'judgement/TricksterTrouble/sick', 'judgement/TricksterTrouble/good', 'judgement/TricksterTrouble/bad', 'judgement/TricksterTrouble/shit'} -- What it'll grab | Make sure sprite is in mods/images
local numPrefix = 'judgement/TricksterTrouble/num'                -- Easier to change numbers | Name it like "rednum" or "Invnum"
local numSuffix = ''

local combType = 'judgement/TricksterTrouble/combo'               -- For swappin with pixel 'n such
local missType = 'miss'
...
local ratingScale = {0.54, 0.54}        -- You can guess what these are for | DEFAULT: rating = 0.69, 0.69 | num = 0.5, 0.5
local numScale = {0.48, 0.48}             -- IF you mess with the numScale, be sure to adjust it's spacing down below as they might overlap
local combThgnScale = {0.52, 0.52}
