...
IntroTagColor = '98FF9C'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	setTextSize('JukeBoxText', IntroTextSize)
        setTextFont('JukeBoxText', "happyTrees.ttf")
	...
	setObjectCamera('JukeBoxSubText', 'other')
        setTextColor('JukeBoxSubText', '98FF9C')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
        setTextFont('JukeBoxSubText', "happyTrees.ttf")
