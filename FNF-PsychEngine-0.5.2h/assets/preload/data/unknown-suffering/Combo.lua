...
local ratingGrab = {'judgement/Wed Infidelity/sick', 'judgement/Wed Infidelity/good', 'judgement/Wed Infidelity/bad', 'judgement/Wed Infidelity/shit'} -- What it'll grab | Make sure sprite is in mods/images
local numPrefix = 'judgement/Wed Infidelity/num'                -- Easier to change numbers | Name it like "rednum" or "Invnum"
local numSuffix = ''

local combType = 'judgement/Wed Infidelity/combo'               -- For swappin with pixel 'n such
local missType = 'miss'
...
local numScale = {0.7, 0.7}             -- IF you mess with the numScale, be sure to adjust it's spacing down below as they might overlap
