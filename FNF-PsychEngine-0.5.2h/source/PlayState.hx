...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeBar.createFilledBar(0xFF8C8C8C, 0xFFFFFFFF);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			scoreTxt.text = 'Score: ' + songScore + ' | Combo Breaks: ' + songMisses + ' | Accuracy: 0% ' + ratingFC;
		} else {
			scoreTxt.text = 'Score: ' + songScore + ' | Combo Breaks: ' + songMisses + ' | Accuracy: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '% ' + ' [' + ratingFC + ']';
		}
		if(SONG.song == 'Triggered-Guerrilla' || SONG.song == 'Slaughter-Guerrilla' || SONG.song == 'Overkill-Guerrilla' || SONG.song == 'Fallout-Guerrilla' || SONG.song == 'Triggered-Remastered' || SONG.song == 'Slaughter-Guerrilla-Old' || SONG.song == 'Kapow-Guerrilla' ||SONG.song == 'Compass-Guerrilla' || SONG.song == 'Disturbed-Guerrilla') {
			scoreTxt.text = 'Score: ' + songScore + ' / Accuracy: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%' + ' [' + ratingFC + '] / Combo Breaks: ' + songMisses + ' / Ranked: ' + ratingName;
		}
		if(SONG.song == 'Disclosed') {
			scoreTxt.text = 'Score: ' + songScore + ' | Sacrifices: ' + deathCounter + ' | Sanity: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '% ' + ' [' + ratingFC + ']';
		}
		if(SONG.song == 'Suicide-Out') {
			scoreTxt.text = 'Score: ' + songScore + ' | Upset Disney: ' + songMisses + ' | Sanity: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '% ' + ' [' + ratingFC + ']';
		}
		if(SONG.song == 'Megalophobia') {
			scoreTxt.text = "Score: " + songScore + " • Failed Notes: " + songMisses + " • Sanity: " + ratingName + " [" + Highscore.floorDecimal(ratingPercent * 100, 2) + "% " + " | " + ratingFC + "]";
		}
		if(SONG.song == 'Eye-to-Eye') {
