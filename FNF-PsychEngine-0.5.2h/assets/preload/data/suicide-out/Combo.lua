...
local ratingGrab = {'judgement/funkinAVI/sick', 'judgement/funkinAVI/good', 'judgement/funkinAVI/bad', 'judgement/funkinAVI/shit'} -- What it'll grab | Make sure sprite is in mods/images
local numPrefix = 'judgement/funkinAVI/num'                -- Easier to change numbers | Name it like "rednum" or "Invnum"
local numSuffix = ''

local combType = 'judgement/funkinAVI/combo'               -- For swappin with pixel 'n such
local missType = 'miss'
