function onCreate()	
	makeAnimatedLuaSprite("ratings","ratings",1010,530);
...
if songName == 'Suicide-Out' or songName == 'Unknown-Suffering' then

	makeAnimatedLuaSprite("ratings","ratings_Grey",1010,530);
	addLuaSprite("ratings",true);
	setScrollFactor('ratings',0,0);
	setObjectCamera('ratings','hud');
	scaleObject('ratings',0.6,0.6);
