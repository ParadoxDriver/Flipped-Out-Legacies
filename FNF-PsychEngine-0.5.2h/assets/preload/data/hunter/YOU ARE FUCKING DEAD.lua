...
function onGameOver()
	...
	setProperty('retry.alpha', 0);
        ...
        setPropertyFromClass('lime.app.Application', 'current.window.title', "Friday Night Funkin': Vs Flippy Flipped Out! Legacy Edition - Mi Huevo AAAA") --For some reason the name of the application does not change with this script :(
end   
