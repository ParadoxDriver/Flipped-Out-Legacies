...
IntroSubTextSize = 29 --size of the text for the Song Name.
IntroTagColor = '308A68'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	setTextSize('JukeBoxText', IntroTextSize)
        setTextFont('JukeBoxText', "sonic4.ttf");
	...
	setObjectCamera('JukeBoxSubText', 'other')
        setTextColor('JukeBoxSubText', '308A68')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
        setTextFont('JukeBoxSubText', "sonic4.ttf");
