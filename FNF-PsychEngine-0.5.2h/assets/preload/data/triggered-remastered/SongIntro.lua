...
IntroSubTextSize = 26 --size of the text for the Song Name.
IntroTagColor = '53E52C'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	--the text for the "Now You Playing" bit
	makeLuaText('JukeBoxText', 'Now You Playing:', 300, -305-IntroTagWidth, 30)
	setTextAlignment('JukeBoxText', 'left')
	setObjectCamera('JukeBoxText', 'other')
	setTextSize('JukeBoxText', IntroTextSize)
        setTextFont('JukeBoxText', "Antilles.ttf")
	...
	setObjectCamera('JukeBoxSubText', 'other')
        setTextColor('JukeBoxSubText', '53E52C')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
        setTextFont('JukeBoxSubText', "Antilles.ttf")
