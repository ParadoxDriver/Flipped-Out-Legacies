...
function onCreatePost()
	...
	for i=1, #directions do
		makeAnimatedLuaSprite('strum'..directions[i], 'NoteSkins/GHOUL_NOTE_assets', getPropertyFromGroup('opponentStrums', i-1, 'x') + 322 --[[ screenWidth / 2 - 2*177 + 105 * i--]], defaultstrumy)
